...
export const metadata = {
  title: 'Discovery Financial Advisor | Ryan',
  description: 'Discovery Financial Advisor | Ryan – South Africa Discovery financial advisor specialising in short-term insurance, life cover, and Discovery Bank products.',
};
    ...
    <html lang="en">
      <body style={{ margin: 0, fontFamily: 'Montserrat, Arial, sans-serif', background: '#f5f5f5' }}>
        <header style={{ background: '#0a1e3a', padding: '1rem 2rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <div style={{ color: '#ffd700', fontWeight: 700, fontSize: '1.5rem' }}>Discovery Financial Advisor | Ryan</div>
          <nav>
        ...
        <footer style={{ background: '#0a1e3a', color: '#fff', textAlign: 'center', padding: '2rem 1rem', marginTop: '4rem' }}>
          &copy; {new Date().getFullYear()} Discovery Financial Advisor | Ryan. All rights reserved.
        </footer>
      </body>
    </html>
  );
